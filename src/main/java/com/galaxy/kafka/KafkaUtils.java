 ...
 */
package com.galaxy.kafka;

import com.google.common.base.Preconditions;

import com.galaxy.kafka.trident.GlobalPartitionInformation;
import com.galaxy.kafka.trident.IBrokerReader;
import com.galaxy.kafka.trident.StaticBrokerReader;
import com.galaxy.kafka.trident.ZkBrokerReader;
...
import static com.galaxy.kafka.StringScheme.deserializeString;
    ...
    public static Iterable<List<Object>> generateTuples(KafkaConfig kafkaConfig, Message msg, String topic) {
        ...
        if (key != null && kafkaConfig.scheme instanceof KeyValueSchemeAsMultiScheme) {
            ...
            if (kafkaConfig.scheme instanceof StringMultiSchemeWithTopic) {
                ...
                String data = StringScheme.deserializeString(payload);
                byte[] bytes = data.getBytes();
                tups = kafkaConfig.scheme.deserialize(bytes);
            }
        }
        return tups;
    }
