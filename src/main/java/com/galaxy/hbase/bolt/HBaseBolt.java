...
import com.galaxy.hbase.common.BatchHelper;
import com.galaxy.hbase.common.TupleUtils;
...
public class HBaseBolt  extends AbstractHBaseBolt {
    ...
    public void execute(Tuple tuple) {
        try {
            ...
            LOG.error("HbaseBolt failed, " + e.getMessage());
            batchHelper.fail(e);
            batchMutations.clear();
        }
    }
